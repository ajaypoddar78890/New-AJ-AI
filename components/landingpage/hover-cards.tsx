...
export function CardHoverEffectDemo() {
  return (
    <div className="container-fluid bg-black py-5 md:py-20 h-[100vh]">
      <div className=" container   mx-auto px-8   ">
         <div className="content text-center my-10 mx-w-5xl">
         <h2 className="text-md md:text-5xl text-white font-extra ">Core features that make it valuable</h2>
         </div>
